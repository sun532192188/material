...
$(function(){
	   ...
	   $.each(resultList,function(i,obj){
		   if(i%50==0){
			  ...
			  resultHtml += '<span style="width:38%;height:50px; border-bottom:1px solid red;margin-left: 33%;">'; 
			  resultHtml += '<span style="width:100%;height:45px; border-bottom:1px solid red;font-size: 35px;text-align: center;">'; 
			  resultHtml += '${statisTime}库    存    物    资    入    库    统    计'; 
			  resultHtml += '</span>'; 
			  resultHtml += '</span>'; 
			  resultHtml += '</td>'; 
			  resultHtml += '</tr>';
              ...
              resultHtml += '<li style="margin-left:0%;">&nbsp;供应商:&nbsp;${supplierName}</li>';
              resultHtml += '<li>时间:&nbsp;${nowTime}</li>';
		   ...
		   resultHtml += '<td style="text-align: left; width: 28%;">'+obj.specModel+'</td>';
		   ...
		   resultHtml += '<td style="text-align: right; width:12%;">'+obj.formatMoney+'</td>';
		   ...
		   if((i+1)%50==0){
				  ...
				  resultHtml += '<td colspan="9" style="text-align: left;">&nbsp;${type}记录:&nbsp;</td>'; 
				  resultHtml += '</tr>'; 
				  resultHtml += '<tr>'; 
	   ...
	   $("#goodsContent").append(resultHtml);
	    ...
	    var storageType ="${queryArgs.storageType}";
	    location.href="${ctx}/storage/staticsStoragePager?goodsName="+goodsName+"&categoryOne="+categoryOne+"&categoryTwo="+categoryTwo+"&supplierId="+supplierId+"&startDate="+startDate
...
<body>
    ...
    <table align="center" style="width: 99%;" id="goodsContent">
        <%-- <thead>
           <tr style="height: 70px;vertical-align:top;">
             ...
             <!--  font-size:50px;border:1px solid red;height:60px;margin-top: 5px;border-bottom:1px solid black; -->
                  <span style="width:38%;height:50px; border-bottom:1px solid red;margin-left: 33%;">
			       <span style="width:100%;height:45px; border-bottom:1px solid red;font-size: 35px;text-align: center;">
			         ${statisTime}库    存    物    资    入    库    统    计
			       </span>
			      </span>
              </td>
           </tr>
           <tr>
              <td style="text-align: left;border: none;width: 100%;" colspan="9"> 
                <table>
                  <tr>
                     <td>&nbsp;供应商:&nbsp;${supplierName}</td>
		             <td>&nbsp;${nowTime}</td>
		             <td>&nbsp;金额:&nbsp;元</td>
                  </tr>
                </table>
                 <ul class="header_ul">
                    <li style="margin-left:0%;">供应商:&nbsp;${supplierName}</li>
                    <li>${nowTime}</li>
                    <li>金额:&nbsp;元</li>
                 </ul>
              </td>
