...
<title>部门用户列表</title>
<link rel="stylesheet" type="text/css" href="${ctx}/resources/ztree/css/zTreeStyle.css">
...
<body>
    ...
    <div id="tree" class="ztree" style="width: 13%;height: 100%;float: left;border: 1px solid #C0C0C0;margin-top:6px;"></div>  
  ...
  <script type="text/javascript">                                                                                                                                                                                        
	 $(function(){
		 //展开分类 树
		 getCategory(0);
		 $("#FunctionContent").prop("src","${ctx}/category/queryCategoryPager");
