...
<script type="text/javascript">                                                                                                                                                                                        
	...
	function loadDepartStock(url){
		...
		location.href=url+"?goodsName="+goodsName+"&type="+type+"&categoryOne="+categoryOne+"&categoryTwo="+categoryTwo+"&goodsType=1&returnPage=departmentCenter/departStock/list";
	}
...
<body>                        
    ...
    <div class="rightinfo">                                                                                                                                                                                            
	    ...
	    <jsp:include page="/commons/pager.jsp">                                                                                                                                                                        
	    	<jsp:param value="departStockPager?goodsName=${queryArgs.goodsName}&categoryOne=${queryArgs.categoryOne}&categoryTwo=${queryArgs.categoryTwo}&type=${queryArgs.type}&goodsType=1&returnPage=departmentCenter/departStock/list" name="url"/>                                                                                                                                                 
	    </jsp:include>                                                                                                                                                                                                 
    </div> 
</body>                                                                                                                                                                                                                
</html>                                                                                                                                                                                           