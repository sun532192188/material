...
<body style="height: 100%; overflow-X: hidden;">
	<div class="formbody"
		...
		<form method="post" action="${ctx}/user/updateUser" id="userForm">
		     <input type="hidden" name="id" value="${user.id}">
			<div>
				<ul class="forminfo" style="float: left;">
					<li style="margin-top: 30px"><label><b>*</b>用户名称</label><input
						name="userName" type="text" class="dfinput" value="${user.userName}" readonly="readonly"/></li>
					<li style="margin-top: 30px"><label><b>*</b>密码</label><input
						id="password" name="password" type="password" class="dfinput" value="${user.password}"/></li>
