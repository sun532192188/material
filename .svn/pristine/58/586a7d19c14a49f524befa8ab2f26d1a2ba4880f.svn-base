...
<body style="height: 100%;width:100%; overflow-X: hidden;">
	<div class="ru">
		<ul>
			<li style="margin-left: 35px;"><label
				style="font-weight: bold; font-size: 15px;">供应商:</label>&nbsp;&nbsp;
				<b style="font-size: 15px;"></b> <b style="font-size: 15px;"
				id="storageMoney">${supplierName}</b></li>
			<li><label style="font-weight: bold; font-size: 15px;margin-left: 80px;">合计金额:</label>
				<b style="font-size: 15px;"></b> <b style="font-size: 15px;"
				id="storageMoney">${sumMoney}元</b></li>
			<li><label style="font-weight: bold; font-size: 15px;margin-left: 80px;">编号:</label><b
				style="font-size: 15px;">${operatNo}</b></li>
		</ul>
	</div>
