...
<script type="text/javascript">                                                                                                                                                                                        
	...
	function loadGoods(url){
		...
		location.href=url+"?goodsName="+goodsName+"&categoryOne="+categoryOne+"&categoryTwo="+categoryTwo+"&status="+status+"&supplierId="+supplierId+"&returnType=2";
	}
	...
	function dataExport(operatType){
		...
		var url = "${ctx}/dataOperatController/goodsDataOperat?goodsName=" + goodsName + "&categoryOne="
				...
				+ status+"&operatType="+operatType+"&supplierId="+supplierId+"&rows="+1000000+"&title=商品列表"+"&returnType=2";
		if(operatType == 1){
			location.href = url;
		}else{
			 window.open(url);
    ...
    <div class="rightinfo">                                                                                                                                                                                            
	  <div class="queryArea">
		    	...
		    	<thead>                                                                                                                                                                                             
			    	<tr>   
				       ...
				       <!--  <th>所属一级分类</th> -->
				        ...
				        <th>所属供应商</th>
				        <th>状态</th>
				        <c:if test="${loginManager.roleId eq 1 or loginManager.roleId eq 2}">
	    ...
	    <jsp:include page="/commons/pager.jsp">                                                                                                                                                                        
	    	<jsp:param value="queryGoodsPager?goodsName=${goodsQueryArgs.goodsName}&categoryOne=${goodsQueryArgs.categoryOne}&categoryTwo=${goodsQueryArgs.categoryTwo}&status=${goodsQueryArgs.status}&supplierId=${goodsQueryArgs.supplierId}&returnType=2" name="url"/>                                                                                                                                                 
	    </jsp:include>                                                                                                                                                                                                 
    </div> 
