...
<script type="text/javascript">                                                                                                                                                                                        
	...
	function loadYSRK(url){
		...
		location.href=url+"?supplierId="+supplierId+"&operatNo="+operatNo+"&startDate="+startDate+"&endDate="+endDate+"&type=1";
	}
	
	//实现库存出库打印与导出
	function dataExport(operatType,storageId,supplierId){
		var url ="${ctx}/dataOperatController/yanshouAndYucunOperat?title=物资验收入库单&storageId="+storageId+"&type=1&operatType="+operatType+"&supplierId="+supplierId;
		if(operatType == 1){
			location.href = url;
		}else{
			 window.open(url);
	...
	function updateInit(id){
		 $("#FunctionContent").prop("src",'${ctx}/storage/updateStorageInit?storageId='+id+"&storageType=1");
	} 
	    ...
	    <div class="tools"> 
	    	<ul class="toolbar">
	    	    <li> <span><img src="${ctx}/resources/platform/images/d04.png" /></span>
			       <a href="javascript:;" onclick="addInit('${ctx}/storage/addInit?type=1');" class="tclick">验收入库&nbsp;&nbsp;</a>
			     </li> 
		       <li> <span><img src="${ctx}/resources/platform/images/d06.png" /></span>
			    ...
			    验收编号:                                                                                                                                                                                                       
        	<input id="operatNo" name="operatNo" type="text" value="${queryArgs.operatNo}"  class="courseinput"  style="border-radius:4px;" placeholder="验收编号"/>&nbsp;&nbsp;  
        	   开始时间:                                                                                                                                                                                                       
...
<script type="text/javascript">
  ...
  function queryStorageGoods(id,supplierName,operatNo,sumMoney){
	  ...
	  var url = "${ctx}/storage/queryStorageGoods?id="+id+"&supplierName="+supplierName+"&operatNo="+operatNo+"&sumMoney="+sumMoney+"&returnPage=storage/storage_goods";
	 $("#FunctionContent").prop("src",url);
  }
</script>                                                                                                                                                                                                            
</html>                                                                                                                                                                                           