...
<script type="text/javascript">
				 ...
				 $("#chur").click(function(){
					 if(type == 'success'){
						 $(".tip").fadeOut(200);
				  		 ...
				  		 var saveRoleId = "${saveRoleId}";
				  		 window.parent.parent.getRole(0);
				  		 window.parent.loadInit(saveRoleId);
					 }
				 });
			 }
	 ...
	 function sunbmitForm(){
		 ...
		 if(num == 0){
			 ...
			 $("#roleForm").prop("action","${ctx}/role/addRole");
			 $("#roleForm").submit();
		 }
	 }
</script>
	    	...
	    	<div>
			    <ul class="forminfo" style="float: left;">
			      <li style="margin-top: 30px">
				       <label><b>*</b>角色名称</label><input id="roleName" name="roleName"  type="text" class="dfinput" value="" onblur="checkRoleName();"/>
				   </li>
				    <li style="margin-top: 30px">
