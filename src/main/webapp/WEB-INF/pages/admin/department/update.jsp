...
<body style="height:100%;overflow-X:hidden;">
    <div class="formbody" style="height:100%;overflow: scroll;overflow-x:hidden;">
	 <div class="formtitle"><span>基本信息</span><b style="color: red;padding-left: 450px" id="errorInfo">${errorInfo}</b></div>
	  <form method="post" action="${ctx}/department/updateDepart" id="updateDepartForm">
	    	<input type="hidden" name="id" value="${department.id}">
	    	<div>
			    <ul class="forminfo" style="float: left;">
				    <li style="margin-top: 30px">
				      <label><b>*</b>部门名称</label><input name="departmentName" type="text" class="dfinput" value="${department.departmentName}"/>
				   </li>
				   <li style="margin-top: 30px">
				      <label><b>*</b>电话</label><input id="phone" name="phone" type="text" class="dfinput" onkeyup="value=value.replace(/[^\d]/g,'')" value="${department.phone}"/>
				   </li>
				    <li style="margin-top: 30px">
				      <label><b>*</b>描述</label> <textarea style="resize: none;" name="description" cols="" rows="" class="textinput">${department.description}</textarea>
				   </li>
				   <li><label>&nbsp;
				    </label><input type="submit"  class="btn2" value="修改部门"/>
				   </li>
			     </ul>
           </div>
   		</form>
