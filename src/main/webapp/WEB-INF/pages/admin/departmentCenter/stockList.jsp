...
<script type="text/javascript">
	$(function() {
		...
		if (operatType == 1) {
			...
			requestUrl ="${ctx}/departmentCenter/queryDepartStockList";
			returnPage = "departmentCenter/outStock/outstock";
			installPath = "${ctx}/goods/installGoods";
		}else if(operatType == 4){
			requestUrl ="${ctx}/departmentCenter/queryDepartStockList";
			returnPage = "departmentCenter/outStock/updateOutstock";
			installPath = "${ctx}/goods/installGoods";
		}
		//查询商品信息
		queryStockList("goodsContent", requestUrl, "", "","", installPath,returnPage, operatNo,stockType,"");
		//分类操作
	...
	function loadGoods() {
		...
		installPath = "${ctx}/departmentCenter/installPlanGoods";
		queryStockList("goodsContent", requestUrl, "", "","", installPath,returnPage, operatNo,stockType,""); */
		queryAllGoods("goodsContent", "${ctx}/goods/queryAllGoods", "goodsName",
				"", "${ctx}/goods/installGoods", "departmentCenter/monthPlan/plan_goods", "", categoryOne,
				categoryTwo);
	}
