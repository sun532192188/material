	  ...
	  var resultList =  eval('${resultList}');
	   ...
	   $.each(resultList,function(i,obj){
		   ...
		   if(i%10==0){
              ...
              resultHtml += '<li style="margin-left:0%;">调拨部门:&nbsp;${targetDepartName}</li>';
		   ...
		   if((i+1)%10==0){
				  ...
				  resultFoot2 += '</tr>';  
				  resultFoot2 += '</table>';
				  resultFoot2 +='<div style="float: left;margin-top:20%;">第<br/>二<br/>联<br/>&nbsp;&nbsp;<br/>调<br/>拨<br/>部<br/>门<br/>留<br/>存</div>';
...
<%--     <div>
		...
		<thead>
			<tr style="height:70px; vertical-align: top;">
				<td colspan="10" style="border: none;" align="center">
				    <span style="width:36%;height:50px; border-bottom:1px solid red;margin-left: 33%;">
			...
			<tr>
			   <td style="text-align: left;border: none;width: 100%;" colspan="10"> 
                 <ul class="header_ul">
                    <li style="margin-left:0%;">&nbsp;部门名称:&nbsp;${departName}</li>
                    <li style="margin-left:0%;">调拨部门:&nbsp;${targetDepartName}</li>
                     <li>&nbsp;${time}</li>
                    <li>&nbsp;编号:&nbsp;${operatNo}</li>
                 </ul>
              </td>
	...
	<div style="float: left;margin-top: 20%;">第<br/>一<br/>联<br/>&nbsp;&nbsp;<br/>本<br/>部<br/>门<br/>留<br/>存</div>
   </div>
   <div style="position: absolute;top:53%;">
	...
	<div style="float: left;margin-top:20%;">第<br/>二<br/>联<br/>&nbsp;&nbsp;<br/>调<br/>拨<br/>部<br/>门<br/>留<br/>存</div>
   </div> --%>
</body>
</html>
