...
<body style="height: 100%; overflow-X: hidden;">
	<div class="ru">
		<ul>
			<li style="margin-left:2%;"><label
				style="font-weight: bold; font-size: 15px;">部门:</label>&nbsp;&nbsp;
				<b style="font-size: 15px;"></b> <b style="font-size: 15px;"
				id="storageMoney">${departName}</b></li>
			<li><label style="font-weight: bold; font-size: 15px;margin-left:22%;">合计金额:</label>
				<b style="font-size: 15px;"></b> <b style="font-size: 15px;"
				id="storageMoney">${sumMoney}元</b></li>
			<li><label style="font-weight: bold; font-size: 15px;margin-left:22%;">编号:</label><b
